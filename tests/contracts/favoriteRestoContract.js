...
const itActsAsFavoriteRestoModel = (favoriteResto) => {
  ...
  it('can return all of the eesto that have been added', async () => {
    favoriteResto.putResto({ id: 1 });
    favoriteResto.putResto({ id: 2 });
  ...
  it('should handle request to remove a eesto even though the eesto has not been added', async () => {
    favoriteResto.putResto({ id: 1 });
    favoriteResto.putResto({ id: 2 });
    favoriteResto.putResto({ id: 3 });
  ...
  it('should be able to search for resto', async () => {
    ...
    expect(await favoriteResto.searchResto('restaurant a')).toEqual([
